!function (e, t) {
    ...
    e.createStore = function e(o, i, u) {
        var a;
        if ("function" == typeof i && void 0 === u && (u = i, i = void 0), void 0 !== u) {
            if ("function" != typeof u) throw Error("Expected the enhancer to be a function.");
            return u(e)(o, i)
        }
        if ("function" != typeof o) throw Error("Expected the reducer to be a function.");
        var c = o, f = i, d = [], s = d, l = !1;
        ...
        function y(e) {
            ...
            return p(), s.push(e), function () {
                if (t) {
                    if (l) throw Error("You may not unsubscribe from a store listener while the reducer is executing. See https://redux.js.org/api-reference/store#subscribe(listener) for more details.");
                    t = !1, p();
                    var r = s.indexOf(e);
                    s.splice(r, 1)
                }
        ...
        function b(e) {
            ...
            for (var t = d = s, r = 0; t.length > r; r++) (0, t[r])();
            return e
        }

        return b({type: r.INIT}), (a = {
            dispatch: b, subscribe: y, getState: h, replaceReducer: function (e) {
                if ("function" != typeof e) throw Error("Expected the nextReducer to be a function.");
                c = e, b({type: r.REPLACE})
            }
        })[t] = function () {
            var e, r = y;
            return (e = {
                subscribe: function (e) {
                    if ("object" !== (void 0 === e ? "undefined" : n(e)) || null === e) throw new TypeError("Expected the observer to be an object.");
        ...
        for (var t = Object.keys(e), n = {}, o = 0; t.length > o; o++) {
            var u = t[o];
        ...
        try {
            !function (e) {
                Object.keys(e).forEach(function (t) {
                    var n = e[t];
                    if (void 0 === n(void 0, {type: r.INIT})) throw Error('Reducer "' + t + "\" returned undefined during initialization. If the state passed to the reducer is undefined, you must explicitly return the initial state. The initial state may not be undefined. If you don't want to set a value for this reducer, you can use null instead of undefined.");
        ...
        return function () {
            ...
            if (c) throw c;
            for (var r = !1, o = {}, u = 0; a.length > u; u++) {
                var f = a[u], d = e[f], s = (0, n[f])(d, t);
                if (void 0 === s) {
                    var l = i(f, t);
                    throw Error(l)
                }
        ...
        if ("object" !== (void 0 === e ? "undefined" : n(e)) || null === e) throw Error("bindActionCreators expected an object or a function, instead received " + (null === e ? "null" : void 0 === e ? "undefined" : n(e)) + '. Did you write "import ActionCreators from" instead of "import * as ActionCreators from"?');
        for (var r = Object.keys(e), o = {}, i = 0; r.length > i; i++) {
            var a = r[i], c = e[a];
            "function" == typeof c && (o[a] = u(c, t))
        }
        return o
        ...
        return function (e) {
            return function () {
                ...
                var u = e.apply(void 0, n), c = function () {
                    ...
                    getState: u.getState, dispatch: function () {
                        return c.apply(void 0, arguments)
                    }
                }, d = t.map(function (e) {
                    return e(f)
                });
                return c = a.apply(void 0, d)(u.dispatch), o({}, u, {dispatch: c})
            }
        }
    }, e.compose = a, e.__DO_NOT_USE__ActionTypes = r, Object.defineProperty(e, "__esModule", {value: !0})
});